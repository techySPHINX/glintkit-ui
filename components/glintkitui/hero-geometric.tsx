  ...
  return (
    <motion.div
      ...
      transition={{
        duration: 2.4,
        delay,
        // Cast the cubic bezier array to a tuple of 4 numbers
...
const fadeUpVariants: Variants = {
  ...
  visible: (i: number) => ({
    ...
    transition: {
      duration: 1,
      delay: 0.5 + i * 0.2,
      ease: "easeInOut", // Use string easing preset instead of number array
    },
  }),
};
    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image
              src="https://cdn.glintkit.com/glintkitui/codesnippetui.svg"
              alt="GlintKit UI"
              width={20}
              height={20}
            />
